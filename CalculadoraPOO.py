...
class Calculadora:
    ...
    def __init__(self, ventana):
        ...
        botondiv=self.colocar_Boton("/", mostrar=True) #para no mostrar operacion booleana
        ...
        botonx=self.colocar_Boton("x", mostrar=True) 
        ...
        botonrest=self.colocar_Boton("-", mostrar=True) #para no mostrar operacion booleana
        ...
        botonmas=self.colocar_Boton("+", mostrar=True) #para no mostrar operacion booleana
        
        #-------------------------------
        
        botones=[boton7, boton8, boton9, botondiv, boton4, boton5, boton6,
        botonx, boton1, boton2, boton3, botonrest, botoncero, botoncoma, botonigual, botonmas] #lista
    ...
    def colocar_Boton(self, valor, mostrar=True, ancho=9, alto=1):
        ...
        return Button(self.ventana, text=valor, width=ancho, height=alto, font=("Courier", 9),
...
raiz.mainloop() # para que se ejecute en bucle